...
import com.example.music_streamer.databinding.SectionSongListRecyclerRowBinding
...
class SectionSongsAdapter(private val songIdList: List<String>):
    RecyclerView.Adapter<SectionSongsAdapter.MyViewHolder>() {
